<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectAssignment.aspx.cs" Inherits="My_Project.Admin.ProjectAssignment" %>
...
&nbsp;
                        ...
                        <br />
                        <br />
                        <asp:Label ID="Label3" runat="server" Text="WorkerId"></asp:Label>
&nbsp;&nbsp;
                        <br />
                        <asp:DropDownList ID="DropDownList2" runat="server" Height="16px" Width="136px">
                        </asp:DropDownList>
                        <br />
                        <br />
                        <br />
