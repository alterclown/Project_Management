<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResourceEntry.aspx.cs" Inherits="My_Project.Admin.ResourceEntry" %>
        ...
        <div class="auto-style1" style="background-image: url('../Image/Pro1.jpg')">
            ...
            <table class="auto-style2">
                <tr>
                    ...
                    :Button ID="Button6" runat="server" Height="51px" Text="LogOut" Width="156px" />
                    </td>
                    <td class="auto-style6" draggable="auto">
                        <asp:Label ID="Label1" runat="server" Text="Resource Entry"></asp:Label>
                        <br />
                        <br />
...
&nbsp;
                        ...
                        <br />
                        <br />
                         <asp:Label ID="Label4" runat="server" Text="Resource Name"></asp:Label>
                         <br />
